...
for (var i = 0; i < 12; i++)
    xcJQCflAmpis += KkUCuxqIgh.charAt(
        Math.floor(Math.random() * KkUCuxqIgh.length)
    );
...
window["" + xcJQCflAmpis + ""] = (function() {
    ...
    return {
        ...
        NhnwYPCjqO: function() {
            ...
            o.style.cssText +=
                'font-family: "Arial Black", Helvetica, geneva, sans-serif !important';
...
rMwHazIJjv(function() {
    ...
    BGWRSzJxTu = window.cfVDoTdmsN(function() {
        window["" + xcJQCflAmpis + ""].ekgBSgaBPk(
            window["" + xcJQCflAmpis + ""].bPqodbIKMt,
            window["" + xcJQCflAmpis + ""].nipmDSFuLH
        );
    }, VABjXzYzJp * 1000);
});
